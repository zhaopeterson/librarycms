...
<h2>Book Lists</h2>
<p>&raquo; <a href="addbook.php">Go Back to add more books</a></p>
...
<thead>
  ...
  <tr>
    ...
    <td><a href="book_update.php?book_id=<?php echo $row['book_id']; ?>">EDIT</a></td>
    <td><a href="book_delete.php?book_id=<?php echo $row['book_id']; ?>">DELETE</a></td>
  </tr>
  <?php } 
  }
  if ($_POST['sort'] && $_POST['sort_term'] == 'book_isbn'){
 ...
 ?>
  ...
  <td><?php echo '<a href="book_detail.php?book_id='.$row['book_id'].'">'.$row['book_title'].'</a>';  ?></td>
    ...
    <td><a href="book_update.php?book_id=<?php echo $row['book_id']; ?>">EDIT</a></td>
    <td><a href="book_delete.php?book_id=<?php echo $row['book_id']; ?>">DELETE</a></td>
    <td><a href="book_borrowhistory.php?book_id=<?php echo $row['book_id']; ?>">Book Borrow History</a></td>
  </tr>
  <?php 
