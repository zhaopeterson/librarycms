...
$sql="SELECT reserves.reserve_id, member_id,reserve_date,  book_title, quantity, due_date
FROM reserves,reserves_content, books
WHERE  reserves.reserve_id=reserves_content.reserve_id AND books.book_id=reserves_content.book_id AND reserves.reserve_id=$reserve_id";
