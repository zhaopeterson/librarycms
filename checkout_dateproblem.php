...
if(mysqli_affected_rows($conn)==1){
	...
	echo "Current inventory: ".$new_bookinventory."<br/>";
		...
		//$sql_bh="INSERT INTO book_history (book_id, member_id, member_quantity, reserve_date, due_date, inventory_initial, inventory_current) VALUES ('2','2','1',$reserve_date,$due_date,'5','5')";
		$sql_bh="INSERT INTO book_history2(book_id, member_id, member_quantity, reserve_date, due_date) VALUES ($book_id,$member,$qty,'2011-05-21 20:19:08','2011-06-20 08:19:32')";
		$result_bh=mysqli_query($conn, $sql_bh);
		if($result_bh){
			echo "Success!!";
		} else{
			echo "Can not insert to the table";
		}
		//$stmt2->prepare($sql_bh);
		//$stmt2->bind_param('iiissii', $book_id, $member_id, $qty, $reserve_date, $due_date, $inventory_ini, $new_bookinventory);
